...
{
    public class FrmCrearCurso_83KI : Form, IObservadorIdioma
    {
        ...
        public FrmCrearCurso_83KI(IGestorCurso_83KI gestorCurso)
        {
        ...
        private void InicializarControles()
        {
            ...
            txtNombre = new TextBox { Left = 20, Top = 45, Width = 360 };
            Controls.Add(txtNombre);
            lblDescripcion = new Label { Left = 20, Top = 80, Width = 360 };
            Controls.Add(lblDescripcion);
            txtDescripcion = new TextBox { Left = 20, Top = 105, Width = 360, Height = 70, Multiline = true, ScrollBars = ScrollBars.Vertical };
            Controls.Add(txtDescripcion);
            lblCargaHoraria = new Label { Left = 20, Top = 185, Width = 360 };
            Controls.Add(lblCargaHoraria);
            nudCargaHoraria = new NumericUpDown { Left = 20, Top = 210, Width = 120, Minimum = 1, Maximum = 10000, Value = 1 };
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                _gestorCurso.CrearCurso(txtNombre.Text, txtDescripcion.Text, Convert.ToInt32(nudCargaHoraria.Value));
        ...
        {
            Text = IdiomaUiHelper_83KI.Texto("FrmCrearCurso.Titulo");
            ...
            btnGuardar.Text = IdiomaUiHelper_83KI.Texto("FrmGestionCursos.Crear");
